...
## Note, I had to do this twice...

I must have completed the problem but not committed the code. So I either have to do it again,
or just hardcode the answers (which is dumb).
